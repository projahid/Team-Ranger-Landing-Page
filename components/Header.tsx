    ...
    <header className={`fixed top-0 w-full z-50 transition-all duration-300 ${isScrolled ? "bg-[#0a0a0f]/90 backdrop-blur-md border-b border-white/5 py-4" : "bg-transparent py-6"}`}>
      <div className="container mx-auto px-4 flex items-center justify-between">
        ...
        <div className="flex items-center gap-4">
          <Button className="bg-[#4de172] hover:bg-[#3dcc60] text-black font-bold rounded-full px-8 h-10 transition-all shadow-[0_0_15px_rgba(77,225,114,0.3)] hover:shadow-[0_0_20px_rgba(77,225,114,0.5)]">
            Login
          </Button>
        </div>
      </div>
